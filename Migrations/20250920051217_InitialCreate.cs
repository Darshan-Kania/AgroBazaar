    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 20, 5, 12, 17, 482, DateTimeKind.Utc).AddTicks(8901), "Fresh vegetables from local farms", null, true, "Vegetables" },
                    { 2, new DateTime(2025, 9, 20, 5, 12, 17, 482, DateTimeKind.Utc).AddTicks(8935), "Seasonal fresh fruits", null, true, "Fruits" },
                    { 3, new DateTime(2025, 9, 20, 5, 12, 17, 482, DateTimeKind.Utc).AddTicks(8963), "Rice, wheat, and other grains", null, true, "Grains" },
                    { 4, new DateTime(2025, 9, 20, 5, 12, 17, 482, DateTimeKind.Utc).AddTicks(8991), "Lentils, beans, and other pulses", null, true, "Pulses" },
